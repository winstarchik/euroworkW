...
const steps = [
  ...
  },
  {
    ...
    desc: 'Наши специалисты подбирают подходящие вакансии из базы проверенных работодателей. Вы выбираете понравившиеся предложения.',
    duration: '3–7 дней',
  },
  {
    icon: CheckCircle2,
    ...
    desc: 'Организуем онлайн-собеседование с работодателем (если требуется). После одобрения вы получаете официальный договор.',
    duration: '7–14 дней',
  },
  {
    icon: FileText,
